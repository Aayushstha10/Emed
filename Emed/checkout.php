<?php
    // Retrieve the total amount sent from cart.php
...
<body>
    ...
    <table >
        <tbody>
            ...
            <tr>
                <td>Amount:</td>
                <td><input type="text" id="amount" name="amount" value="<?php echo $total_amount; ?>" class="form" required=""><br></td>
            </tr>
            <tr>
                <td>Tax Amount:</td>
            ...
            <tr>
                <td>Total Amount:</td>
                <td><input type="text" id="total_amount" name="total_amount" value="<?php echo $total_amount; ?>" class="form" required=""></td>
            </tr>
            <tr>
            ...
            <tr>
                <td>Success URL:</td>
                <td><input type="text" id="success_url" name="success_url" value="http://localhost/FP/order.php" class="form" required=""></td>
            </tr>
            <tr>
                <td>Failure URL:</td>
